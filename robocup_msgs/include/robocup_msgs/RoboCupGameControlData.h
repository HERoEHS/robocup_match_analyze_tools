...
// -----------------------------------------------------------------------
// Custom defines (backward compat for BT nodes, not in official header)
// -----------------------------------------------------------------------

// Backward compat: old secondary state values (synthesized from gamePhase + setPlay)
...
// RoboWorld states (team custom)
#define ROBOWORLD_IDLE  0
#define ROBOWORLD_TRACK 1
#define ROBOWORLD_SERVE 2
#define ROBOWORLD_GIVE  3
